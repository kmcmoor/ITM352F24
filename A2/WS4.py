...
def display_rows(data):
    while True:
        ...
        if user_choice == '': #Empty string means the user hit enter
...
def display_menu(data):
    ...
    choice = int(input(f"Select an option between 1 and {num_choices}: ")) # Put this into a try and except lock
